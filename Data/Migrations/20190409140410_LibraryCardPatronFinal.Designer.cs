...
namespace Data.Migrations
{
    ...
    [Migration("20190409140410_LibraryCardPatronFinal")]
    partial class LibraryCardPatronFinal
    {
            ...
            modelBuilder.Entity("Data.Models.Checkout", b =>
                {
                    ...
                    b.Property<int?>("LibraryCardPatronId");
                    ...
                    b.HasIndex("LibraryCardPatronId");
            ...
            modelBuilder.Entity("Data.Models.Checkout", b =>
                {
                    ...
                    b.HasOne("Data.Models.LibraryCard", "LibraryCard")
                        .WithMany("Checkouts")
                        .HasForeignKey("LibraryCardPatronId");
                });
            ...
            modelBuilder.Entity("Data.Models.LibraryCard", b =>
                {
                    b.HasOne("Data.Models.Patron", "Patron")
                        .WithOne("LibraryCard")
                        .HasForeignKey("Data.Models.LibraryCard", "PatronId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
